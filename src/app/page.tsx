          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a className="bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-full font-semibold hover:bg-white/30 transition-all duration-300 flex items-center gap-2" href="https://mhassan.info" target="_blank" rel="noreferrer">
                  <FaGlobe /> Website
                </a>
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="w-80 h-80 rounded-full overflow-hidden ring-4 ring-white/20 shadow-2xl">
                  <Image src="/profile.jpg" alt="Profile photo of Mohammad Hassan" fill className="object-cover" />
                </div>
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center text-white text-2xl">
                  <FaCode />
                </div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-r from-green-400 to-blue-500 rounded-full flex items-center justify-center text-white text-xl">
                  <FaCloud />
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  technologies: ["Node.js", "Python", "AWS", "Docker", "LLM", "Machine Learning", "Terraform", "Kubernetes"]
                },
                {
                  role: "Tech Lead",
                  company: "Friisbee",
                  ...
                  technologies: ["Node.js", "TypeScript", "Terraform", "Snowflake", "DBT", "Fivetran", "AWS", "Docker"]
                },
                {
                  ...
                  technologies: ["Node.js", "AWS CDK", "TypeScript", "GitLab CI/CD", "PostgreSQL", "Redis", "Docker"]
                },
                {
                  role: "Software Engineer",
                  company: "Checkatrade",
                  ...
                  technologies: ["Node.js", "AWS EventBridge", "Lambda", "DynamoDB", "CloudWatch", "Serverless", "TypeScript"]
                },
                {
                  ...
                  technologies: ["Python", "Node.js", "GPU Computing", "Docker", "Kubernetes", "Redis", "WebSockets", "AWS"]
                },
                {
                  role: "Full Stack Engineer",
                  company: "Callaly",
                  ...
                  highlights: [
                    ...
                    "Developed AWS Serverless microservices for payment processing and subscription management",
                    "Implemented automated billing system handling 10K+ subscriptions with 99.9% accuracy",
                  ...
                  technologies: ["Python", "Django", "React", "AWS Lambda", "Stripe API", "PostgreSQL", "Docker", "CloudFormation"]
                }
              ].map((job) => (
